...
if sys.platform.startswith('win'):
    ...
    ARGS = ['$(python3-config --includes)', '-I/ds/native_client/kenlm', '-I/fst/src/include', '-I/ds/native_client/', '-I/ds/native_client/ctcdecode/third_party/object_pool/', '-c', '-fPIC', '-DKENLM_MAX_ORDER=6', '-std=c++11', '-Wno-unused-local-typedefs', '-Wno-sign-compare']
    OPT_ARGS = ['-O3', '-DNDEBUG']
