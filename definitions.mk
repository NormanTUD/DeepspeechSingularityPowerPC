...
PYTHON_PLATFORM_NAME := --plat-name manylinux1_ppc64le
endif
endif
...
$(DS_SWIG_BIN_PATH)/swig:
	mkdir -p $(SWIG_ROOT)
	wget --no-check-certificate -O - "$(SWIG_DIST_URL)" | tar -C $(SWIG_ROOT) -zxf -
	#[  -f /ds/native_client/ds-swig/bin/swig ] && rm /ds/native_client/ds-swig/bin/swig
	#rm /ds/native_client/ds-swig/bin/swig
	ls $(which swig)
	#ln -s $(which swig) /ds/native_client/ds-swig/bin/swig 
	cd $(SWIG_ROOT)/../
